...
class ClientSettingsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        notificationSwitch=view.findViewById(R.id.notification_cswitch)
        saveButton=view.findViewById(R.id.save_cbutton)
        logoutButton=view.findViewById(R.id.logout_cbutton)
        ...
        logoutButton.setOnClickListener {
            auth.signOut()
            val intent= Intent(activity,ClientloginActivity::class.java)
