 ...
 * Use the [DesignerSearchFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class DesignerSearchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_designer_search, container, false)
        searchView=view.findViewById(R.id.search_viewd)
        recyclerView=view.findViewById(R.id.search_resultsd)
    ...
    companion object {
         ...
         * @return A new instance of fragment DesignerSearchFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DesignerSearchFragment().apply {
